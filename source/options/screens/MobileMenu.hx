...
class MobileMenu extends OptionScreen {
    public override function create() {
        options = [
            {
                name: "Hitbox Opacity",
                desc: "FUCK MY ASS STUPID NIGGER",
                value: "",
                onCreate: function(e) {e.check(Settings.engineSettings.data.hitboxopacity);},
                onSelect: function(e) {e.check(Settings.engineSettings.data.hitboxopacity = !Settings.engineSettings.data.hitboxopacity);},
            },
            {
